...
// --- pricing (research/02 + 25), USD per 1M tokens: input / cached-input / output --
interface PriceRow {
  input: number;
  cached: number;
  output: number;
...
/** GLM-5.2 tier table (research/02; re-confirmed docs.fireworks.ai 2026-07-03). */
...
/** DeepSeek-V4-Pro tier table (docs.fireworks.ai/serverless/pricing, 2026-07-03). */
const DEEPSEEK_PRO_PRICING: Partial<Record<ServiceTier, PriceRow>> = {
  standard: { input: 1.74, cached: 0.145, output: 3.48 },
...
const DEEPSEEK_FLASH_PRICING: Partial<Record<ServiceTier, PriceRow>> = {
  standard: { input: 0.14, cached: 0.028, output: 0.28 },
