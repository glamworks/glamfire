...
export const TOGETHER_MODELS: Record<string, TogetherModelInfo> = {
  ...
  [TOGETHER_DEEPSEEK_MODEL]: {
    ...
    // vs Together's 512K, and cheaper: $1.74/$3.48 vs $2.10/$4.40).
    quantization: 'FP4+FP8',
    thinking: true,
    // research/25 §B + Together launch announcement (2026): $2.10 in / $0.20
    // cached (10.5x discount) / $4.40 out. Live-verify against an invoice once
    // a TOGETHER_API_KEY exists (see MANUAL-VERIFY.md).
    pricing: { input: 2.1, cached: 0.2, output: 4.4 },
  },
};
